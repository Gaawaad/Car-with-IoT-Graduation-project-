...
PORT_Cfg_t PORT_Cfg_Arr[] = {
    ...
    {PORTB, PORT_Pin0, DIGITAL_ENABLE, ALTERNATE_ENABLE, UART, INPUT, LOW, FLOATING_PIN},    //UART1
    {PORTB, PORT_Pin1, DIGITAL_ENABLE, ALTERNATE_ENABLE, UART, OUTPUT, LOW, FLOATING_PIN},  //UART1
    {PORTB, PORT_Pin2, DIGITAL_ENABLE, ALTERNATE_DISABLE, NONE_FNC, INPUT, LOW, FLOATING_PIN},  //T3CCP0  //Ultrasonic echo
    ...
    {PORTF, PORT_Pin1, DIGITAL_ENABLE, ALTERNATE_DISABLE, NONE_FNC, OUTPUT, HIGH, FLOATING_PIN},
